...
import { faGooglePlusG,faFacebookSquare, faInstagram, faLinkedin } from "@fortawesome/free-brands-svg-icons";
...
const SocialMediaIcons = [
    ...
    { id: 3, link: 'http://instagram.com', icon: Instagram, alt:'icon instagram' },
