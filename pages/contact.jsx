...
import { StyledLink, Styledbutton } from "../components/UI/Buttons";
import { GridTwo } from "../components/UI/Grid";
            ...
            <ContactInfo>
              <li>
                <img
                  ...
                  width="25"
                  height="20"
                  alt="icon-mail-airhitect"
                />
                <StyledLink
                  href="mailto:job@airhitect.com"
                  alt="job@airhitect.com"
                >
                  job@airhitect.com
                </StyledLink>
              </li>
              <li>
                <img
                  src="/static/images/icons/phone-call.png"
                  width="25"
                  height="24"
                  alt="icon-call-airhitect"
                />
                <p>
